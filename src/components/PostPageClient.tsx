...
export default function PostPageClient({
  ...
  const replace = (node: DOMNode) => {
    ...
    if (elem.name === 'a') {
      ...
      const baseClass = "text-gray-600 hover:text-gray-700 underline transition-colors duration-200";
          ...
          <article className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <footer className="p-8 border-t border-gray-200 bg-gray-50">
              <Link
                ...
                className="inline-flex items-center gap-2 text-gray-600 hover:text-gray-700 font-bold transition-colors"
              >
